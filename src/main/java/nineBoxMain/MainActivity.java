...
public class MainActivity extends AppCompatActivity implements OnShowcaseEventListener {
    ...
    private String import_or_export_selected = "neither";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.toggle_tutorial:
                ...
                return true;
            case R.id.export_db:
                setImport_or_export_selected_to_export();
...
//            }
    ...
    * */
    ...
    public void verifyStoragePermissionsForExport(Activity activity) {
        ...
        System.out.println(" ******** EXPORT - inside verifyStoragePermissionsForExport ***********");
    ...
    public void verifyStoragePermissionsForImport(Activity activity) {
        ...
        System.out.println(" ######## IMPORT - inside verifyStoragePermissionsForImport ######### ");
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    if (getImport_or_export_selected() == "export") {
                        try {
                            export_DB(this);
                        } catch (IOException e) {
                            e.printStackTrace();
            ...
            case MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE:
                if (getImport_or_export_selected() == "import") {
                    if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                        promptForImportFile(MainActivity.this);
                    } else {
                        // permission denied!
